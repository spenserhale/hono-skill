---
source: https://github.com/honojs/website/blob/main/docs/getting-started/google-cloud-run.md
live: https://hono.dev/docs/getting-started/google-cloud-run
upstream_commit: a597bd40c01dd00a2ec2d8afd550c1ffebd2f7f1
synced: 2026-04-18
---

<!-- Synced from https://github.com/honojs/website/blob/main/docs/getting-started/google-cloud-run.md -->
<!-- For the latest version fetch: https://raw.githubusercontent.com/honojs/website/main/docs/getting-started/google-cloud-run.md -->
